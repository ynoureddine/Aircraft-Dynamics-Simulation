...
def Run_Sim(SIM, CONSTANTS, Atmosphere, plane1,FuelMass):

    # Begin at input start time
    TIME = SIM.START_TIME
    
    plane1.design.max_fuel_mass = FuelMass
    plane1.design.mass = plane1.design.max_fuel_mass+plane1.design.empty_mass
    ...
    plane1.Calc_Forces(CONSTANTS, Atmosphere, plane1.state.pos_ENU[2],TIME,SIM)
    ...
    while (TIME < SIM.END_TIME - CONSTANTS.TOLERANCE and plane1.state.pos_ENU[2] >= 0 and plane1.design.empty_mass < plane1.design.mass):
        # Update atmosphere conditions
        Atmosphere.Update_Atmo(plane1.state.pos_ENU[2], TIME)
    ...
    elif plane1.design.empty_mass > plane1.design.mass:
        print("\033[91m" + "Simulation stopped due to aircraft running out of fuel - Data output to post_processing/output.csv" + "\033[0m")          
    else:
